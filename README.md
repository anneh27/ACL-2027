...
- Still open: the Week 2/3 Cherokee conditions B/C came from Claude subagents whose answers were hand-transcribed into scripts, so their "raw outputs" are not verifiable originals. Re-running that pilot through the real API (P1) has not been done.
